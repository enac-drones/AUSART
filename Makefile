...
# configuration
exe := gcs-ppz
srcs_sma := src/main.sma src/PanAndZoom.sma src/Aircraft.sma src/AircraftManager.sma src/AircraftDrone.sma src/SectorManager.sma src/Sector.sma src/Dialog.sma src/VFRPoint.sma src/Heliport.sma src/FlightPlan.sma src/FlightPlanManager.sma src/PolygonGeometry.sma src/Button.sma src/Trajectory.sma
